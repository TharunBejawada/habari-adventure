...
export default function BottomCTA() {
  ...
  <a 
    ...
    className="inline-flex items-center justify-center bg-[#25D366] text-white hover:bg-[#25D366]/70 hover:text-white font-bold text-base md:text-lg py-2.5 md:py-3.5 px-6 md:px-10 rounded-full transition-transform hover:scale-105 shadow-lg shadow-[#25D366]/20 text-center gap-2"
  >
