        ...
        <div className="max-w-[1400px] mx-auto w-[96%] px-4 sm:px-6 flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-center text-center lg:items-start lg:text-left z-20">
            ...
            <div className="animate-fade-in-up w-full" style={{ animationDelay: '0.1s' }}>
              ...
              <h2 className="headingCSS text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mb-6 text-gray-900">
                About <span className="text-[#135D66]">Habari Adventure</span>
              </h2>
            </div>

            {/* Animated About Text */}
            <div className="descCSS text-left animate-fade-in-up text-gray-600 text-sm sm:text-base leading-relaxed space-y-4 mb-10 max-w-2xl" style={{ animationDelay: '0.2s' }}>
              <p>
            ...
            <div className="animate-fade-in-up w-full flex items-center justify-start gap-4 mb-10" style={{ animationDelay: '0.3s' }}>
              <h3 className="headingCSS text-2xl font-bold text-[#135D66]">How It Works</h3>
              <span className="h-[2px] bg-[#fe6e00]/30 flex-1 max-w-[100px] lg:max-w-[200px] rounded-full"></span>
            </div>
            ...
            <div className="animate-fade-in-up grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-12 w-full max-w-2xl" style={{ animationDelay: '0.4s' }}>
              ...
              {/* Step 01 */}
              <div className="p-7 relative bg-white sm:p-8 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-gray-100 flex flex-col items-center text-center mt-4 group hover:-translate-y-2 transition-transform duration-300">
            ...
            <div className="animate-fade-in-up mt-10 inline-flex items-center justify-center lg:justify-start gap-3 px-5 py-3 rounded-full bg-[#fe6e00]/10 border border-[#fe6e00]/20 w-full sm:w-auto" style={{ animationDelay: '0.5s' }}>
              <span className="relative flex h-3 w-3 shrink-0">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#fe6e00] opacity-75"></span>
                <span className="relative inline-flex rounded-full h-3 w-3 bg-[#fe6e00]"></span>
              </span>
              <p className="descCSS text-xs sm:text-sm font-semibold text-[#135D66] text-left">
                Our team responds within <span className="text-[#fe6e00] font-bold">3 hours</span> with tailored recommendations.
              </p>
            </div>
