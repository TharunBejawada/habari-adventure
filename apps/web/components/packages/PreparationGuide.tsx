        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-20">
          ...
          <motion.div variants={itemVariants}>
            <div className="flex items-end gap-4 mb-6">
              ...
              />
              <h3 className="text-[1.35rem] font-medium text-[#fe6e00] pb-1">Fitness & Training</h3>
            </div>
          ...
          <motion.div variants={itemVariants}>
            <div className="flex items-end gap-4 mb-6">
              ...
              <img 
                ...
                className="w-16 h-16 object-contain"
              />
              <h3 className="text-[1.35rem] font-medium text-[#fe6e00] pb-1">Altitude & Health</h3>
            </div>
            <div className="space-y-0 text-black text-[15px] leading-[1.8]">
          ...
          <motion.div variants={itemVariants}>
            <div className="flex items-end gap-4 mb-6">
              ...
              <img 
                ...
                className="w-16 h-16 object-contain"
              />
              <h3 className="text-[1.35rem] font-medium text-[#fe6e00] pb-1">Packing Essentials</h3>
            </div>
            <div className="space-y-0 text-black text-[15px] leading-[1.8]">
              ...
              <p>warm hat & gloves</p>
              <p>0 to -10°C sleeping bag (<span className="text-[#fe6e00]">rental available</span>)</p>
