        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-end justify-between gap-10 lg:gap-12">
          ...
          >
            <motion.h2 
              ...
              className="text-3xl md:text-[2.5rem] font-bold text-[#fe6e00] mb-4 leading-[1.15] tracking-tight"
            >
          ...
          >
            ...
            <motion.a 
              ...
              className="group flex flex-col items-center gap-3 cursor-pointer"
            >
              <div className="w-[85px] h-[85px] rounded-full border-[2.5px] border-[#333] flex items-center justify-center text-[#333] group-hover:border-[#fe6e00] group-hover:text-[#fe6e00] transition-colors duration-300 bg-transparent">
                <FiMail className="w-8 h-8" strokeWidth={1.5} />
              </div>
              <span className="font-medium text-black text-[15px] leading-tight text-center group-hover:text-[#fe6e00] transition-colors">
                Send an<br/>Enquiry
              </span>
            </motion.a>
