  ...
  year: 'numeric' 
        ...
        <div className="mt-8 pt-6 border-t border-gray-100 flex items-center gap-2">
          ...
          <p className="text-gray-700 font-medium">
            Want your own private dates? <Link href={`${getLangPrefix(lang)}/contact`} className="text-[#135D66] hover:text-[#fe6e00] hover:underline font-bold transition-colors">Contact us for a custom departure.</Link>
          </p>
        </div>
