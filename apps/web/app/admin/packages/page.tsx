...
export default function PackagesAdminPage() {
    ...
    <div className="max-w-[1400px] mx-auto p-4 sm:p-6 lg:p-8 space-y-8 min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 rounded-2xl shadow-sm border border-gray-200">
        ...
        <Link 
          ...
          className="px-6 py-3 bg-[#fe6e00] hover:bg-[#c98616] text-white font-bold rounded-xl shadow-md transition-all flex items-center gap-2 hover:-translate-y-0.5"
        >
                  ...
                  <tr key={pkg.id} className="hover:bg-gray-50/50 transition-colors group">
                    ...
                    {/* <td className="p-4 text-right pr-6">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <Link href={`/admin/packages/editor?slug=${encodeURIComponent(pkg.slug)}`} className="p-2 text-gray-400 hover:text-[#fe6e00] hover:bg-orange-50 rounded-lg transition-all" title="Edit Package">
  ...
  <div className="flex items-center justify-end gap-2">
    <Link 
      href={`/${pkg.slug}`} 
      target="_blank" 
      className="px-3 py-1.5 text-sm font-medium text-gray-600 hover:text-[#135D66] hover:bg-[#E9F4F5] rounded-lg transition-all" 
      title="View on Website"
    >
      View
    </Link>
    <Link 
      href={`/admin/packages/editor?slug=${encodeURIComponent(pkg.slug)}`} 
      className="px-3 py-1.5 text-sm font-medium text-gray-600 hover:text-[#fe6e00] hover:bg-orange-50 rounded-lg transition-all" 
      title="Edit Package"
    >
      Edit
    </Link>
    <button 
      ...
      className="px-3 py-1.5 text-sm font-medium text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all disabled:opacity-50 flex items-center justify-center gap-2" 
