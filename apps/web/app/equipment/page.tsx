      ...
      <section className="relative w-full h-[55vh] min-h-[450px] flex flex-col justify-center -mt-[120px] pt-[120px] overflow-hidden bg-[#0a0f16]">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-12 text-center reveal-on-scroll is-visible">
          ...
          <div className="inline-flex items-center gap-2 bg-black/40 backdrop-blur-sm border border-white/10 px-4 py-2 rounded-full mt-4">
            <svg className="w-4 h-4 text-[#F51A43]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 flex flex-col lg:flex-row gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/4 hidden lg:block">
            <div className="sticky top-32 space-y-2">
              ...
              <div className="mt-12 bg-gray-50 p-6 rounded-2xl border border-gray-100">
                ...
                <Link href="/contact" className="text-sm font-bold text-[#F51A43] hover:underline transition-colors">
          ...
          <div className="w-full lg:w-3/4 space-y-20">
            ...
            <div id="mountain-tents" className="reveal-on-scroll scroll-mt-32">
              <h2 className="text-3xl font-extrabold text-[#F51A43] mb-6">Mountain Tents</h2>
              <div className="prose prose-lg text-gray-600 max-w-none space-y-6">
                <p>
                ...
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 my-6 shadow-sm">
                  <ul className="list-none pl-0 m-0 space-y-3">
                    <li className="flex items-start gap-3">
                      <span className="text-[#F51A43] mt-1">✓</span>
            ...
            <div id="sleep-systems" className="reveal-on-scroll scroll-mt-32">
              <h2 className="text-3xl font-extrabold text-[#F51A43] mb-6">Sleep Systems</h2>
              ...
              {/* Callout */}
              <div className="mt-8 bg-[#111827] p-6 rounded-2xl border-l-4 border-[#F51A43] shadow-md">
                <p className="text-white font-medium m-0">
                  <strong className="text-[#F51A43] uppercase tracking-wider text-sm mr-2">Note:</strong> 
            ...
            <div id="private-toilets" className="reveal-on-scroll scroll-mt-32">
              <h2 className="text-3xl font-extrabold text-[#F51A43] mb-6">Private Toilets</h2>
              <div className="prose prose-lg text-gray-600 max-w-none space-y-6">
                <p>
            ...
            <div id="safari-vehicles" className="reveal-on-scroll scroll-mt-32">
              <h2 className="text-3xl font-extrabold text-[#F51A43] mb-6">Our Safari Vehicles</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
                  <div className="w-12 h-12 rounded-full bg-[#F51A43]/10 text-[#F51A43] flex items-center justify-center mb-4">
