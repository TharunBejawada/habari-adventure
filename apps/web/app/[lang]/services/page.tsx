      ...
      <section className="relative w-full h-[55vh] min-h-[450px] flex flex-col justify-center -mt-[150px] pt-[120px] overflow-hidden bg-[#0a0f16]">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-12 text-center reveal-on-scroll is-visible">
          ...
          <div className="inline-flex items-center gap-2 bg-black/40 backdrop-blur-sm border border-white/10 px-4 py-2 rounded-full mt-4">
            <svg className="w-4 h-4 text-[#fe6e00]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 flex flex-col lg:flex-row gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-3/4 space-y-20">
            ...
            <div id="overview" className="reveal-on-scroll scroll-mt-32">
              ...
              <div className="prose prose-lg text-gray-600 max-w-none space-y-6">
                ...
                <blockquote className="border-l-4 border-[#fe6e00] pl-6 italic text-gray-800 font-medium my-8 text-xl">
                  ...
                  <span className="text-sm font-bold text-[#fe6e00] not-italic mt-2 block">— Stan Wilfred, C.E.O</span>
                </blockquote>
              </div>
            </div>
            ...
            <div id="accommodation" className="reveal-on-scroll scroll-mt-32">
              <h2 className="text-3xl font-extrabold text-[#fe6e00] mb-6">Accommodation</h2>
              <div className="prose prose-lg text-gray-600 max-w-none space-y-6">
                <p>
            ...
            <div id="meals" className="reveal-on-scroll scroll-mt-32">
              <h2 className="text-3xl font-extrabold text-[#fe6e00] mb-6">Meals on the Mountain</h2>
              <div className="prose prose-lg text-gray-600 max-w-none space-y-6">
                <p>
            ...
            <div id="safety" className="reveal-on-scroll scroll-mt-32">
              <h2 className="text-3xl font-extrabold text-[#fe6e00] mb-6">Safety & Awareness</h2>
              <div className="prose prose-lg text-gray-600 max-w-none space-y-6">
                <p>
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 list-none pl-0">
                  <li className="flex items-center gap-3 bg-gray-50 p-4 rounded-lg border border-gray-100">
                    <svg className="w-6 h-6 text-[#fe6e00] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
            ...
            <div id="altitude" className="reveal-on-scroll scroll-mt-32">
              <h2 className="text-3xl font-extrabold text-[#fe6e00] mb-6">Altitude Effect</h2>
              <div className="prose prose-lg text-gray-600 max-w-none space-y-6">
                <p>
            ...
            <div id="health" className="reveal-on-scroll scroll-mt-32">
              <h2 className="text-3xl font-extrabold text-[#fe6e00] mb-6">Health Checks & Medication</h2>
              <div className="prose prose-lg text-gray-600 max-w-none space-y-6">
                <p>
                ...
                <h4 className="text-xl font-bold text-[#fe6e00] mt-8 mb-4">Regarding Diamox</h4>
                <p>
