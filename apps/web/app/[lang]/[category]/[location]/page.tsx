    ...
    <div className="bg-[#FDFEFE] min-h-screen font-sans text-gray-800">
      ...
      <section className="relative w-full pt-32 pb-40 lg:pt-48 lg:pb-56 overflow-hidden -mt-[150px] z-0">
        ...
        <div className="max-w-[1000px] mx-auto w-[96%] relative z-20 flex flex-col items-center text-center px-4">
          ...
          <h2 className="headingCSS animate-fade-right mb-6 drop-shadow-sm" style={{ animationDelay: '0.2s' }}>
  <span className="block !text-[48px] !font-[700] !leading-[1.1] text-white">
    <span className="text-[0.85em]">Explore</span>{' '}
    <span className={`notranslate ${caveat.className} text-[#fe6e00] font-normal text-[1.1em]`}>
      {displayTitle}
    </span>
  </span>
</h2>
...
<h1 className="notranslate headingCSS text-[#135D66] mb-4 w-full">
  <span className="block !text-[28px] md:!text-[32px] !font-[600] !leading-[1.3] break-words whitespace-normal hyphens-auto">
    {locationData.h1Text || locationData.title || displayTitle}
      ...
      {/* 3. FAQ SECTION                             */}
      {/* ========================================== */}
      {locationData?.faqs && Array.isArray(locationData.faqs) && locationData.faqs.length > 0 && (
        <section className="py-16 lg:py-24 bg-[#F9FAFB] border-t border-gray-100">
          <div className="max-w-4xl mx-auto px-6 sm:px-12 animate-fade-in">
            ...
            <div className="space-y-4 notranslate">
              {locationData.faqs.map((faq: any, idx: number) => {
