...
export default function PackageLandingPage() {
  ...
  {hasLuxury && (
    ...
    >
      ...
      {/* 6. FAQ SECTION                             */}
      {/* ========================================== */}
      {pkg.faqs && Array.isArray(pkg.faqs) && pkg.faqs.length > 0 && (
        <section className="py-16 lg:py-24 bg-[#F9FAFB] border-b border-gray-100">
          <div className="max-w-4xl mx-auto px-6 sm:px-12 reveal-on-scroll">
                ...
                return (
                  <div key={idx} className="border border-gray-200 rounded-xl overflow-hidden shadow-sm bg-white">
                    <button
                      ...
                      className="w-full flex justify-between items-center p-6 hover:bg-[#E9F4F5] text-left transition-colors"
                    >
