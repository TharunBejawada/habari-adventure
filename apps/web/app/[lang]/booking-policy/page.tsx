              ...
              <div className="descCSS prose prose-lg text-gray-600 max-w-none space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    <span className="font-bold text-[#fe6e00] text-xl">(a)</span>
                    <div>
                      ...
                      <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 list-none pl-0">
                        <li className="bg-[#F9FAFB] p-4 rounded-xl border border-gray-200 font-medium text-gray-800 flex justify-between items-center">
                          <span>0 - 7 days</span>
                          <span className="text-[#fe6e00] font-bold text-xl">35%</span>
                        </li>
                        <li className="bg-[#F9FAFB] p-4 rounded-xl border border-gray-200 font-medium text-gray-800 flex justify-between items-center">
                          <span>7 - 30 days</span>
                          <span className="text-[#fe6e00] font-bold text-xl">20%</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    <span className="font-bold text-[#fe6e00] text-xl">(b)</span>
                    <p>
                  ...
                  <div className="flex items-start gap-4">
                    <span className="font-bold text-[#fe6e00] text-xl">(c)</span>
                    <p>
